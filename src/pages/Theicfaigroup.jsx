  ...
  return (
    <>
      <Seo
        ...
        ogUrl="https://online.ifheindia.org/about-us"
      />
                  ...
                  <div className="row">
                    ...
                    <div className="col-xl-9 col-lg-9 col-md-8">
                      ...
                      <p>
                        ...
                        mark in the educational field with a pan-Indian network
                        and presence.
                      </p>
                      <p>
                        It has established 11 Universities and 9 B-Schools
                        across India including The ICFAI Foundation for Higher
                        Education, which is a deemed-to-be-University.
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        charismatic visionary, institutional builder, and a
                        pioneer in promoting higher education in the private
                        sector.
                      </p>
      ...
      <section>
        <div className="container" id="RDID">
          <div className="row">
            <div className="col-md-12">
                  ...
                  <div className="row">
                    <div className="col-xl-7 col-lg-6 col-md-12 col-12">
                      ...
                      <p>
                        ...
                        was declared a Deemed-to-be-University under Section 3
                        of the UGC Act, 1956.
                      </p>
                      <p>
                        The University has received the NAAC Accreditation "A++"
                        Grade with an impressive Institutional CGPA of 3.59 out
                        of 4.
                      </p>
                      <p>
                        It has the coveted AACSB International Accreditation for
                        the MBA Program and is ranked 27 in the Management
                        Category of India Rankings-2021 (NIRF 2021).
                      </p>
                      <p>
                      ...
                      <p>
                        As a step forward, the University has established a
                        Center for Distance and Online Education (CDOE) to offer
                        programs in online and distance learning modes (ODL).
                      </p>
                    </div>
                ...
                <div className="card-body p-4">
                  <div className="row">
                    ...
                    <div className="col-xl-7 col-lg-6 col-md-12 col-12">
                      ...
                      <p className="mb-1">
                        All programs offered under the online and distance
                        learning modes (ODL) are administered through the Center
                        for Distance and Online Education (CDOE), IFHE
                        Hyderabad.
                      </p>
                      <p className="mb-1">
                        As the real world gets disrupted due to technology,
                        health, economic and social upheavals, businesses face a
                        volatile, uncertain, complex and ambiguous environment.
                      </p>
                      <p className="mb-1">
                        The role of management professionals, with relevant
                        skills and knowledge, to meet these dynamic challenges
                        becomes critical.
                      </p>
                      <p className="mb-1">
                        To enable the aspirants to enter today's competitive
                        business world and sustain their advancement, the CDOE
                        has launched ICFAI Online MBA Program, combining the
                        academic rigour and interdisciplinary perspective.
                      </p>
                      <p className="mb-1">
                        Students are groomed for leadership roles in management
                        profession by excellent faculty and pedagogy supported
                        by vast content resources.
                      </p>
                      <p className="mb-3">
                        ICFAI Online MBA benefits{" "}
                        <a
                          className="text-danger"
                          href="/about-us/the-icfai-group/online-mba-for-freshers"
                          target="_blank"
                        >
                          graduates
                        </a>{" "}
                        ...
                        <a
                          className="text-danger"
                          href="/about-us/the-icfai-group/online-mba-for-working-professionals"
                          target="_blank"
                        >
                          working executives
                        </a>{" "}
                        ...
                        <a
                          href="/about-us/the-icfai-group/online-mba-for-entrepreneurs"
                      ...
                      <div className="card border-0 bg1">
                        <div className="card-body">
                          <h4>
                            <i className="bi bi-award"></i> Ranking
                          </h4>
                          <p>
                            The Online MBA Program has been ranked #1 among
                            India's Top 25 Online MBA Institutions 2022 - by
                            Careers 360.
                          </p>
                        </div>
                      </div>
