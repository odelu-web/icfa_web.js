              ...
              <ul>
                {[
                  { text: "Online MBA Program", href: "/program/online-mba" },
                  {
                    ...
                    href: "/bba/the-icfai-group",
                  },
                  { text: "Program Structure", href: "/bba/program-structure" },
                  { text: "Admissions", href: "/bba/admissions" },
                  { text: "Career Path", href: "/bba/career" },
                  {
                    text: "Apply Online",
                    href: "https://online.ifheindia.org/ifhe-online-mba.asp",
                  },
                  { text: "FAQs", href: "/bba/faqs" },
                  { text: "Privacy Policy", href: "/bba/privacy-policy" },
                ].map(({ text, href }, index) => (
                  <li key={index}>
                    <a
                      href={href}
