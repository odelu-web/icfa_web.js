...
import BbaContactForm from "./BbaContactForm";

const BbaFloatingIcons = () => {
  ...
  return (
    <>
      <section
        className="floatIcons-section"
        style={{ position: "fixed", top: "15%", right: -120 }}
      >
        <ul className="iconList">
          ...
          <li className="item">
            <a
              rel="noreferrer"
              target="_blank"
              href="https://online.ifheindia.org/BBA_OnlineReg/"
              className="link"
            >
              <span className="icon">
                <LazyLoadImage
...
export default BbaFloatingIcons;
