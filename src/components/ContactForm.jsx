...
const ContactForm = () => {
  ...
  const validate = () => {
    ...
    if (!formData.lBestDescribes)
      newErrors.lBestDescribes = "Please select an option.";
    if (!formData.lAreaofInterest)
      newErrors.lAreaofInterest = "Please select an area of interest.";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        BestDescribes: formData.lBestDescribes,
        AreaofInterest: formData.lAreaofInterest,
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-1">
        <select
          name="lBestDescribes"
          value={formData.lBestDescribes}
          onChange={handleChange}
          className="form-select"
        >
          <option value="">What best describes you?</option>
          <option value="Job Aspirant">Job Aspirant</option>
          <option value="Working">Working</option>
          <option value="Business Owner">Business Owner</option>
        </select>
        {errors.lBestDescribes && (
          <div className="text-danger">{errors.lBestDescribes}</div>
        )}
      </div>

      <div className="mb-1">
        <select
          name="lAreaofInterest"
          value={formData.lAreaofInterest}
          onChange={handleChange}
          className="form-select"
        >
          <option value="">What is your area of interest?</option>
        ...
        {errors.lAreaofInterest && (
          <div className="text-danger">{errors.lAreaofInterest}</div>
        )}
      </div>
